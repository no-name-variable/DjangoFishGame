...
def has_active_potion(player, effect_type):
...
def get_potion_effect_value(player, effect_type):
    """Возвращает значение эффекта зелья или None."""
    potion = has_active_potion(player, effect_type)
