...
class QuestService:
    """Сервис квестов: обновление прогресса, проверка завершения."""

    def update_quest_progress(self, player, species, weight, location):
        """
    ...
    def _is_quest_complete(self, pq):
